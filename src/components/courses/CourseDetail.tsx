...
export function CourseDetail() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 bg-gradient-to-b from-blue-50/30 to-white">
      <div className="max-w-4xl mx-auto">
        <Button 
          variant="ghost" 
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-3 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{course.title}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="gradient-card border-0 shadow-md">
            <CardContent className="p-4 flex flex-col items-center justify-center">
              <Clock className="h-10 w-10 mb-2 text-blue-500" />
          ...
          <Card className="gradient-card border-0 shadow-md">
            <CardContent className="p-4 flex flex-col items-center justify-center">
              <BookOpen className="h-10 w-10 mb-2 text-indigo-500" />
          ...
          <Card className="gradient-card border-0 shadow-md">
            <CardContent className="p-4 flex flex-col items-center justify-center">
              <Award className="h-10 w-10 mb-2 text-purple-500" />
        ...
        <Card className="gradient-card border-0 shadow-md mb-8">
          <CardHeader>
        ...
        <Card className="gradient-card border-0 shadow-md mb-8">
          ...
          <CardContent>
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center mr-4 text-indigo-600 font-medium">
